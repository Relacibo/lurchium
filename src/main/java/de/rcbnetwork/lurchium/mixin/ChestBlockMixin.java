...
public class ChestBlockMixin extends AbstractChestBlock<ChestBlockEntity> {


    protected ChestBlockMixin(AbstractBlock.Settings settings, Supplier<BlockEntityType<? extends ChestBlockEntity>> supplier) {
